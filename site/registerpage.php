...
<head>
	...
	<section id="main">
		<div class="slimmer">
			...
			<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
				...
				<div class="g-recaptcha" data-sitekey="6Lfn2H4UAAAAAJoOnhfUrSXxyw7bRlpqQiLGBC1L"></div>
	...
	<!-- Scripts -->
		...
		<script src='https://www.google.com/recaptcha/api.js'></script> <!--Source:https://webdesign.tutsplus.com/tutorials/how-to-integrate-no-captcha-recaptcha-in-your-website--cms-23024 --!>
	</body>
</html>